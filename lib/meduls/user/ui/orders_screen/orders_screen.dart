                  ...
                  children: [
                    TabContainerOder(
                      ...
                      colorTextCount: state.currentIndexTap == 0
                          ...
                          : Colors.white,
                      title: "جديد",
                      count: state.homeUserResponse!.orders!.where((element) => element.order.status == 0).toList().length.toString(),
                      onTap: () {
                    ...
                    TabContainerOder(
                      ...
                      colorTextCount: state.currentIndexTap == 1
                          ...
                          : Colors.white,
                      title: "في التسليم",
                      count: state.homeUserResponse!.orders!.where((element) => element.order.status <=2 && element.order.status>0).toList().length.toString(),
                      onTap: () {
                    ...
                    TabContainerOder(
                      ...
                      colorTextCount: state.currentIndexTap == 2
                          ...
                          : Colors.white,
                      title: "تم التسليم",
                      count:state.orders.where((element) => element.order.status==3).toList().length.toString(),
                      onTap: () {
